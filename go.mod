module github.com/sebousan/uncinq.dev

go 1.21

// replace github.com/hugolify/hugolify-theme => ../../_hugolify/hugolify-theme
...
require (
	...
	github.com/hugolify/hugolify-theme v1.26.5 // indirect
